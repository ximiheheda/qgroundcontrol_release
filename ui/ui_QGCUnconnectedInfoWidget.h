...
public:
    ...
    void setupUi(QWidget *QGCUnconnectedInfoWidget)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/res/QGroundControlConnect"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    {
        QGCUnconnectedInfoWidget->setWindowTitle(QApplication::translate("QGCUnconnectedInfoWidget", "Form", nullptr));
