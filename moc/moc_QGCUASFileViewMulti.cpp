...
#include "../../qgroundcontrol/src/ui/QGCUASFileViewMulti.h"
...
void QGCUASFileViewMulti::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QGCUASFileViewMulti *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QGCUASFileViewMulti::staticMetaObject = { {
    &QGCDockWidget::staticMetaObject,
    qt_meta_stringdata_QGCUASFileViewMulti.data,
    qt_meta_data_QGCUASFileViewMulti,
    qt_static_metacall,
    nullptr,
    nullptr
} };
