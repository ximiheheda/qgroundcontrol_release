...
#include "../../qgroundcontrol/src/MissionManager/PlanManager.h"
...
void PlanManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlanManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PlanManager::*)(bool );
        ...
        {
            using _t = void (PlanManager::*)(int , const QString & );
        ...
        {
            using _t = void (PlanManager::*)(double );
...
QT_INIT_METAOBJECT const QMetaObject PlanManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_PlanManager.data,
    qt_meta_data_PlanManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
