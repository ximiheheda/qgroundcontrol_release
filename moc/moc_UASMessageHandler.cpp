...
#include "../../qgroundcontrol/src/uas/UASMessageHandler.h"
...
QT_INIT_METAOBJECT const QMetaObject UASMessageHandler::staticMetaObject = { {
    &QGCTool::staticMetaObject,
    qt_meta_stringdata_UASMessageHandler.data,
    qt_meta_data_UASMessageHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
