...
#include "../../qgroundcontrol/src/ui/QGCUASFileView.h"
...
void QGCUASFileView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QGCUASFileView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QGCUASFileView::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QGCUASFileView.data,
    qt_meta_data_QGCUASFileView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
