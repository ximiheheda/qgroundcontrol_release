...
#include "../../qgroundcontrol/src/QmlControls/AppMessages.h"
...
QT_INIT_METAOBJECT const QMetaObject AppLogModel::staticMetaObject = { {
    &QStringListModel::staticMetaObject,
    qt_meta_stringdata_AppLogModel.data,
    qt_meta_data_AppLogModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
