...
#include "../../qgroundcontrol/src/MissionManager/QGCFencePolygon.h"
...
struct qt_meta_stringdata_QGCFencePolygon_t {
    QByteArrayData data[5];
    char stringdata0[54];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCFencePolygon_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCFencePolygon_t qt_meta_stringdata_QGCFencePolygon = {
    {
QT_MOC_LITERAL(0, 0, 15), // "QGCFencePolygon"
QT_MOC_LITERAL(1, 16, 16), // "inclusionChanged"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 9), // "inclusion"
QT_MOC_LITERAL(4, 44, 9) // "_setDirty"

    },
    "QGCFencePolygon\0inclusionChanged\0\0"
    "inclusion\0_setDirty"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QGCFencePolygon[] = {
...
void QGCFencePolygon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGCFencePolygon::inclusionChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QGCFencePolygon::staticMetaObject = { {
    &QGCMapPolygon::staticMetaObject,
    qt_meta_stringdata_QGCFencePolygon.data,
    qt_meta_data_QGCFencePolygon,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QGCFencePolygon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCFencePolygon.stringdata0))
