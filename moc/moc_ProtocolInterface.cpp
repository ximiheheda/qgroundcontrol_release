...
#include "../../qgroundcontrol/src/comm/ProtocolInterface.h"
...
void ProtocolInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ProtocolInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ProtocolInterface::*)(int , float );
...
QT_INIT_METAOBJECT const QMetaObject ProtocolInterface::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_ProtocolInterface.data,
    qt_meta_data_ProtocolInterface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
