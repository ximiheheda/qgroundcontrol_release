...
#include "../../qgroundcontrol/src/QtLocationPlugin/QGCMapUrlEngine.h"
...
void UrlFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UrlFactory *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject UrlFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_UrlFactory.data,
    qt_meta_data_UrlFactory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
