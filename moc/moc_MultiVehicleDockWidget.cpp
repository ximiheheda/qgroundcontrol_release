...
#include "../../qgroundcontrol/src/ui/MultiVehicleDockWidget.h"
...
void MultiVehicleDockWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MultiVehicleDockWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MultiVehicleDockWidget::staticMetaObject = { {
    &QGCDockWidget::staticMetaObject,
    qt_meta_stringdata_MultiVehicleDockWidget.data,
    qt_meta_data_MultiVehicleDockWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
