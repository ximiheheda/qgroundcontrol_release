...
void APMAirframeComponentController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (APMAirframeComponentController::*)();
        ...
        {
            using _t = void (APMAirframeComponentController::*)(APMAirframeType * );
...
void APMAirframe::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<APMAirframe *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject APMAirframe::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_APMAirframe.data,
    qt_meta_data_APMAirframe,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
#ifndef QT_NO_PROPERTIES
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<APMAirframeType *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->_name; break;
...
QT_INIT_METAOBJECT const QMetaObject APMAirframeType::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_APMAirframeType.data,
    qt_meta_data_APMAirframeType,
    qt_static_metacall,
    nullptr,
    nullptr
} };
