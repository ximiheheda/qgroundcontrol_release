...
#include "../../qgroundcontrol/src/AnalyzeView/GeoTagController.h"
...
QT_INIT_METAOBJECT const QMetaObject GeoTagWorker::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_GeoTagWorker.data,
    qt_meta_data_GeoTagWorker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GeoTagController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GeoTagController::*)(QString );
        ...
        {
            using _t = void (GeoTagController::*)(double );
        ...
        {
            using _t = void (GeoTagController::*)();
...
QT_INIT_METAOBJECT const QMetaObject GeoTagController::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_GeoTagController.data,
    qt_meta_data_GeoTagController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
