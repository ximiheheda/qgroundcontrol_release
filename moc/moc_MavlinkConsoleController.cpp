...
#include "../../qgroundcontrol/src/AnalyzeView/MavlinkConsoleController.h"
...
QT_INIT_METAOBJECT const QMetaObject MavlinkConsoleController::staticMetaObject = { {
    &QStringListModel::staticMetaObject,
    qt_meta_stringdata_MavlinkConsoleController.data,
    qt_meta_data_MavlinkConsoleController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
