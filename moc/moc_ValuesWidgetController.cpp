...
#include "../../qgroundcontrol/src/FlightMap/Widgets/ValuesWidgetController.h"
...
void ValuesWidgetController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ValuesWidgetController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ValuesWidgetController::*)(QStringList );
...
QT_INIT_METAOBJECT const QMetaObject ValuesWidgetController::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ValuesWidgetController.data,
    qt_meta_data_ValuesWidgetController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
