...
#include "../../qgroundcontrol/src/ui/linechart/Linecharts.h"
...
void Linecharts::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Linecharts *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Linecharts::*)(QString );
...
QT_INIT_METAOBJECT const QMetaObject Linecharts::staticMetaObject = { {
    &MultiVehicleDockWidget::staticMetaObject,
    qt_meta_stringdata_Linecharts.data,
    qt_meta_data_Linecharts,
    qt_static_metacall,
    nullptr,
    nullptr
} };
