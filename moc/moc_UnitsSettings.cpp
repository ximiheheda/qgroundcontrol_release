...
#include "../../qgroundcontrol/src/Settings/UnitsSettings.h"
...
QT_INIT_METAOBJECT const QMetaObject UnitsSettings::staticMetaObject = { {
    &SettingsGroup::staticMetaObject,
    qt_meta_stringdata_UnitsSettings.data,
    qt_meta_data_UnitsSettings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
