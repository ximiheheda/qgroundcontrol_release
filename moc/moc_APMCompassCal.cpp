...
#include "../../qgroundcontrol/src/AutoPilotPlugins/APM/APMCompassCal.h"
...
void CalWorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CalWorkerThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CalWorkerThread::*)(int , int , int , QString );
...
QT_INIT_METAOBJECT const QMetaObject CalWorkerThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_CalWorkerThread.data,
    qt_meta_data_CalWorkerThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<APMCompassCal *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->vehicleTextMessage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (APMCompassCal::*)(int , int , int , QString );
...
QT_INIT_METAOBJECT const QMetaObject APMCompassCal::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_APMCompassCal.data,
    qt_meta_data_APMCompassCal,
    qt_static_metacall,
    nullptr,
    nullptr
} };
