...
#include "../../qgroundcontrol/src/ui/linechart/ChartPlot.h"
...
void ChartPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ChartPlot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ChartPlot::staticMetaObject = { {
    &QwtPlot::staticMetaObject,
    qt_meta_stringdata_ChartPlot.data,
    qt_meta_data_ChartPlot,
    qt_static_metacall,
    nullptr,
    nullptr
} };
