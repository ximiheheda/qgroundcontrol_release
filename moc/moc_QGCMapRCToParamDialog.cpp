...
#include "../../qgroundcontrol/src/ui/QGCMapRCToParamDialog.h"
...
void QGCMapRCToParamDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QGCMapRCToParamDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QGCMapRCToParamDialog::*)(QString , float , float , quint8 , float , float );
...
QT_INIT_METAOBJECT const QMetaObject QGCMapRCToParamDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_QGCMapRCToParamDialog.data,
    qt_meta_data_QGCMapRCToParamDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
