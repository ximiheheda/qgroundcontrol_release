...
#include "../../qgroundcontrol/src/ViewWidgets/CustomCommandWidgetController.h"
...
void CustomCommandWidgetController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomCommandWidgetController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CustomCommandWidgetController::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject CustomCommandWidgetController::staticMetaObject = { {
    &FactPanelController::staticMetaObject,
    qt_meta_stringdata_CustomCommandWidgetController.data,
    qt_meta_data_CustomCommandWidgetController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
