...
#include "../../qgroundcontrol/src/Audio/AudioOutput.h"
...
QT_MOC_LITERAL(1, 12, 3), // "say"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4), // "text"
QT_MOC_LITERAL(4, 22, 13), // "_stateChanged"
QT_MOC_LITERAL(5, 36, 20), // "QTextToSpeech::State"
QT_MOC_LITERAL(6, 57, 5) // "state"

    },
    "AudioOutput\0say\0\0text\0_stateChanged\0"
...
void AudioOutput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->say((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->_stateChanged((*reinterpret_cast< QTextToSpeech::State(*)>(_a[1]))); break;
        default: ;
        }
