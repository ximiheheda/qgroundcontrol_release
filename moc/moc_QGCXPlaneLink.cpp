...
#include "../../qgroundcontrol/src/comm/QGCXPlaneLink.h"
...
void QGCXPlaneLink::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QGCXPlaneLink *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QGCXPlaneLink::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject QGCXPlaneLink::staticMetaObject = { {
    &QGCHilLink::staticMetaObject,
    qt_meta_stringdata_QGCXPlaneLink.data,
    qt_meta_data_QGCXPlaneLink,
    qt_static_metacall,
    nullptr,
    nullptr
} };
